...
# headers["User-Agent"] = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Safari/537.36'
    cookies = {
        ...
        'ALF': '1694096663',
        'SSOLoginState': '1662560663',
        'SCF': 'AhMibtVML7Q3o9_7y8drkiB_cm8tN9exrkuukbRDvTWbeVvW7HE4gxsROPkO_mh3pHAGg0qxomemZFB8wGgnvx0.',
        'SUB': '_2A25OHNnHDeThGeNN7lMQ9C_LwzqIHXVtaEwPrDV8PUNbmtANLW7bkW9NSblWWVgVbg1vEKDzHGIMsClKHhncC1yi',
        '_s_tentry': 'login.sina.com.cn',
        'Apache': '1132070741707.8667.1662560665167',
        'ULV': '1662560665174:21:3:1:1132070741707.8667.1662560665167:1662163351434',
    }
...
# r.encoding='utf-8'
# print(content)
    tilte_list = re.findall(
        '<a href="\/weibo\?q=.*?target="_blank">(.*?)<\/a>', content)
    # print(tilte_list)
